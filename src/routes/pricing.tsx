  ...
  component: () => (
    <div className="min-h-screen bg-[var(--gray-50)]">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-4xl font-extrabold tracking-tight text-[var(--gray-900)]">Pricing</h1>
        <p className="mt-4 text-lg text-[var(--gray-600)]">Plans for institutions, teachers, and individual learners.</p>
