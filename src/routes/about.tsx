  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "about Klassruum, AI classroom company, education technology, virtual classroom platform, accessible education",
      },
      ...
      { property: "og:title", content: "About Klassruum — AI-Powered Virtual Classrooms" },
      {
        ...
        content:
          "Klassruum helps institutions deliver structured, accessible, AI teacher-led learning experiences at scale.",
      },
      ...
      { name: "twitter:title", content: "About Klassruum" },
      {
        ...
        content: "AI-powered virtual classrooms that teach like real teachers.",
      },
    ],
    ...
    >
      <div className="rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] p-8">
        ...
        <p className="mt-4 leading-7 text-[#475569]">
          Klassruum was born from a simple observation: existing online learning tools solve pieces
          of the puzzle — content storage, video conferencing, Q&A chatbots — but none deliver a
          complete, structured lesson with a teacher who writes, explains, checks understanding, and
          responds in real time.
        </p>
        <p className="mt-4 leading-7 text-[#475569]">
          We set out to build the classroom itself: an AI teacher that follows a structured lesson
          plan, writes on an interactive whiteboard, speaks clearly, answers learner questions in
          context, and records everything — notes, transcripts, progress — for review.
        </p>
        <p className="mt-4 leading-7 text-[#475569]">
          Accessibility was never an afterthought. From the beginning, Klassruum was designed for
          deaf learners, low-vision learners, neurodivergent learners, and everyone in between.
          Because a classroom that doesn't include everyone isn't really a classroom.
        </p>
        <p className="mt-4 leading-7 text-[#475569]">
          Today, Klassruum serves schools, universities, tutoring centers, NGOs, and training
          providers — anywhere structured, accessible teaching needs to scale.
        </p>
      </div>
    </InfoPage>
  ),
