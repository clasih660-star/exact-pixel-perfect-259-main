  ...
  return (
    <DashboardShell config={dashboardConfigs.platform_admin} title="Generate Lessons">
      <PageHeader
        ...
        action={
          <a
            href={course ? `/admin/kingpin-courses/${course.id}/lessons` : "/admin/kingpin-courses"}
      ...
      <div className="grid gap-4">
        {[
          [
            "Author-first model",
            "Modules and lessons are curriculum-authored first so each lesson has a stable objective, department context, tool focus, and practice intent.",
          ],
          [
            "AI-assisted enrichment",
            "Generation can expand examples, create alternative scenarios, produce role-specific variations, and draft practice prompts without changing the learning architecture.",
          ],
          [
            "Review checkpoints",
            "Every generated addition should be reviewed for factual quality, workflow realism, bias, weak assumptions, and commercial/course-brand consistency.",
          ],
        ].map(([title, body]) => (
