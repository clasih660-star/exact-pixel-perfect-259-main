    ...
    <DashboardShell config={dashboardConfigs.platform_admin} title="New KingPin Course">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <BlueprintCard
          ...
          text={`${KINGPIN_AI_MASTERCLASS.pricingLabel} direct sale, platform-owned, reusable for licensing and public catalog distribution.`}
          icon={<Sparkles className="h-5 w-5" />}
        />
        <BlueprintCard
          title="Curriculum structure"
          text={`${KINGPIN_AI_MASTERCLASS.modules.length} modules with 2 classroom-ready lessons per module for structured 10–15 minute delivery.`}
          icon={<Layers className="h-5 w-5" />}
        />
        <BlueprintCard
          title="Learning depth"
          text="Each lesson includes context, workflow logic, role application, guided practice, and quality control reflection."
      ...
      <Card className="mt-6 border-[#DDE7F0] bg-white/90">
        <CardContent className="p-6">
          ...
          <ul className="mt-4 space-y-3 text-sm leading-7 text-[#334155]">
            ...
            <li>
              • Every lesson should sustain approximately 10–15 minutes of AI classroom delivery.
            </li>
            <li>
              • Lessons must include multiple sections: context, tool logic, role/department use,
              guided practice, and reflection.
            </li>
            <li>
              • Modules must connect tools to real departments such as education, operations,
              finance, research, HR, marketing, and administration.
            </li>
            <li>
              • The same course should remain reusable for public sales, platform licensing, and
