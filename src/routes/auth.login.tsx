...
export const Route = createFileRoute("/auth/login")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Klassruum login, sign in, AI classroom access, institution login" },
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[540px] flex-col justify-between overflow-hidden bg-[#1A3233] p-10 relative">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-4 text-base leading-relaxed text-[#A3ADAD]">
            Sign in to access your AI-powered virtual classrooms, track learner progress, and manage courses — all in one place.
          </p>
      ...
      <div className="flex flex-1 items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-[400px] space-y-8">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link to="/auth/forgot-password" className="text-xs font-medium text-[#1F7C80] hover:text-[#1A5256]">
                  Forgot password?
                </Link>
              </div>
              <input
            ...
            <button
              type="submit"
              className="w-full rounded-xl bg-[#1F7C80] px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-[#1F7C80]/25 transition-all hover:bg-[#1A5256] hover:shadow-xl hover:shadow-[#1F7C80]/30 focus:outline-none focus:ring-2 focus:ring-[#1F7C80] focus:ring-offset-2"
            >
              Sign in
            </button>
          </form>
          ...
          <p className="text-center text-sm text-[#A3ADAD]">
            ...
            <Link to="/institutions/register" className="font-semibold text-[#1F7C80] hover:text-[#1A5256]">
