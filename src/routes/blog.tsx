  ...
  head: () => ({
    meta: [
      { title: "Blog — Klassruum" },
      {
        name: "description",
        content:
          "Ideas on accessible, teacher-led learning, classroom technology and education for everyone.",
      },
    ],
  }),
  component: () => (
    <InfoPage
      ...
      sections={[
        {
          icon: "🧑‍🏫",
          title: "Teaching that feels human",
          body: "Why structured, spoken, board-led lessons beat walls of text — and how we build them.",
        },
        {
          icon: "♿",
          title: "Designing for every learner",
          body: "Lessons on accessibility that goes deeper than colour contrast and captions.",
        },
        {
          icon: "🌍",
          title: "Education without barriers",
          body: "Reaching learners on modest devices and limited connectivity, from grade one to tertiary.",
        },
      ]}
    >
      <div className="rounded-2xl border border-dashed border-[#CBD5E1] bg-[#F8FAFC] p-8 text-center">
        ...
        <p className="mt-1 text-sm text-[#64748B]">
          Check back soon, or reach out if you'd like to hear when we publish.
        </p>
      </div>
    </InfoPage>
  ),
