...
export const Route = createFileRoute("/classroom")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "AI Virtual Classroom with Voice, Whiteboard & Captions | Klassruum",
      },
      {
  ...
  return (
    <InfoPage
      ...
      sections={[
        {
          icon: "🧑‍🏫",
          title: "A teacher who teaches",
          body: "Lessons are taught step by step — written on the board and explained aloud, just like a classroom you'd walk into.",
        },
        {
          icon: "📝",
          title: "Living whiteboard",
          body: "Concepts, equations and diagrams appear as the teacher writes them, with notes captured automatically for review.",
        },
        {
          icon: "💬",
          title: "Ask anytime",
          body: "Raise your hand, ask by voice or text, and get a grounded answer without losing your place in the lesson.",
        },
        {
          icon: "🎧",
          title: "Captions & audio",
          body: "Every word is captioned and spoken, with adjustable size and speed for the way each learner takes things in.",
        },
        {
          icon: "♿",
          title: "Accessibility first",
          body: "Modes for low vision, deaf, dyslexia, ADHD focus and more reshape the lesson — not just the colours.",
        },
        {
          icon: "📊",
          title: "Evidence, not exams",
          body: "Progress is captured as real learning activity — questions, practice and confidence — never a single high-stakes test.",
        },
      ]}
    />
  );
