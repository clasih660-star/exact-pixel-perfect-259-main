 ...
 */
async function redirectToDashboardForUser(userId: string, navigate: ReturnType<typeof useNavigate>) {
  try {
          ...
          {!supabaseReady && (
            <div className="mb-6 rounded-xl border border-[#A3D9D8] bg-[#F0FDFA] p-4">
              ...
              <p className="mt-1 text-xs text-[#475569]">
                Supabase is not configured. Pick a role below to explore the full app with demo data.
              </p>
            </div>
          )}
