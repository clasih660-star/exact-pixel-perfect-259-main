...
export const MODE_DEFAULTS: Record<LearningMode, {
  ...
  standard: {
    teacherVideo: true, audio: true, captions: true, boardWriting: true,
    textInput: true, voiceInput: true, transcript: true, boardDescriptions: false,
    screenReaderOptimized: false, keyboardNav: false, visualAlerts: false,
    largeButtons: false, reducedMotion: false, hideChat: false, writingSpeed: "normal",
  },
  deaf: {
    teacherVideo: true, audio: false, captions: true, boardWriting: true,
    textInput: true, voiceInput: false, transcript: true, boardDescriptions: false,
    screenReaderOptimized: false, keyboardNav: false, visualAlerts: true,
    largeButtons: false, reducedMotion: false, hideChat: false, writingSpeed: "normal",
  },
  blind: {
    teacherVideo: false, audio: true, captions: true, boardWriting: true,
    textInput: false, voiceInput: true, transcript: true, boardDescriptions: true,
    screenReaderOptimized: true, keyboardNav: true, visualAlerts: false,
    largeButtons: false, reducedMotion: false, hideChat: false, writingSpeed: "slow",
  },
  low_vision: {
    teacherVideo: true, audio: true, captions: true, boardWriting: true,
    textInput: true, voiceInput: true, transcript: true, boardDescriptions: true,
    screenReaderOptimized: true, keyboardNav: true, visualAlerts: true,
    largeButtons: true, reducedMotion: false, hideChat: false, writingSpeed: "normal",
  },
  deaf_blind: {
    teacherVideo: false, audio: false, captions: true, boardWriting: true,
    textInput: true, voiceInput: false, transcript: true, boardDescriptions: true,
    screenReaderOptimized: true, keyboardNav: true, visualAlerts: false,
    largeButtons: true, reducedMotion: false, hideChat: false, writingSpeed: "normal",
  },
  dyslexia: {
  ...
  adhd_focus: {
    ...
    textInput: true, voiceInput: true, transcript: true, boardDescriptions: false,
    screenReaderOptimized: false, keyboardNav: false, visualAlerts: false,
    largeButtons: false, reducedMotion: true, hideChat: true, writingSpeed: "slow",
  },
  motor_support: {
    teacherVideo: true, audio: true, captions: true, boardWriting: true,
    textInput: true, voiceInput: false, transcript: true, boardDescriptions: false,
    screenReaderOptimized: false, keyboardNav: true, visualAlerts: false,
    largeButtons: true, reducedMotion: false, hideChat: false, writingSpeed: "normal",
  },
  speech_difficulty: {
    teacherVideo: true, audio: true, captions: true, boardWriting: true,
  ...
  extra_support: {
    ...
    textInput: true, voiceInput: true, transcript: true, boardDescriptions: true,
    screenReaderOptimized: false, keyboardNav: false, visualAlerts: true,
    largeButtons: true, reducedMotion: false, hideChat: false, writingSpeed: "slow",
  },
  challenge: {
    teacherVideo: true, audio: true, captions: true, boardWriting: true,
    textInput: true, voiceInput: true, transcript: true, boardDescriptions: false,
    screenReaderOptimized: false, keyboardNav: false, visualAlerts: false,
    largeButtons: false, reducedMotion: false, hideChat: false, writingSpeed: "fast",
  },
};
